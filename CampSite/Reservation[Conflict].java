...
public class Reservation
{
   ...
   //Sum of all expenses without car
    ...
    {
        int days = endDate.getEndDate() - this.startDate;
        return days;
    }*/
    
    public int daysDifference(Date startDate, Date endDate){
        int startDateDays = startDate.getDay();
        int endDateDays = startDate.getDay();
